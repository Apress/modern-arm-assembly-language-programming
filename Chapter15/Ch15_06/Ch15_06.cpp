...
void Mat4x4MulF64(MatrixF64& m_src1, MatrixF64& m_src2)
{
    const size_t nr = m_src1.GetNumRows();
    const size_t nc = m_src2.GetNumCols();
    ...
    if (m_des1 != m_des2)
        cout << "\nMatrix compare failed - Mat4x4MulF64\n";
}
...
void Mat4x4MulF64Test(void)
{
    const size_t nr = 4;
    const size_t nc = 4;
    MatrixF64 m_src1(nr ,nc);
    MatrixF64 m_src2(nr ,nc);
